...
if(isset($_POST['count'])){
	...
	<body>
		<div id='controls'>
			...
			<button id='cores-decrement'><span class='glyphicon glyphicon-chevron-left'></span></button>
			<button id='cores-increment'><span class='glyphicon glyphicon-chevron-right'></span></button>
			<p>Speed:<span id='speed'>40</span>ms</p>
			<button id='speed-decrement'><span class='glyphicon glyphicon-chevron-left'></span></button>
			<button id='speed-increment'><span class='glyphicon glyphicon-chevron-right'></span></button>
			<p>Chance (1/x):<span id='chance'>50</span></p>
			<button id='chance-decrement'><span class='glyphicon glyphicon-chevron-left'></span></button>
			<button id='chance-increment'><span class='glyphicon glyphicon-chevron-right'></span></button>
		</div>
		<br/><br/>
		<div class="container">
			<div id='options'>
				<button id='auto' class="btn btn-success">auto</button>
				<button id='keboard' class="btn btn-success">keyboard</button>
